...
export default function List() {
  ...
  const [itemIterator, setItemIterator] = useState(0);
  ...
  return (
    <div className='list-page-container'>
      ...
      <div className='slider'>
        ...
        {listItems.map((item) => {
          <listItem props={item} dataId={itemIterator} />;
          setItemIterator(itemIterator + 1);
        })}
        ...
        <div className='slide' data-id={7}>
          <div className='slide-content'>
            <h1>slide 7</h1>
          </div>
        </div>

        <div className='slide' data-id={8}>
          <div className='slide-content'>
            <h1>slide 8</h1>
          </div>
        </div>

        <div className='slide' data-id={9}>
          <div className='slide-content'>
            <h1>slide 9</h1>
          </div>
        </div>

        <div className='slide' data-id={10}>
          <div className='slide-content'>
            <h1>slide 10</h1>
          </div>
        </div>
          ...
          slides.forEach((slide) => {
            ...
            if (slideDataID > Math.floor(slides.length / 2) + randomSlide) {
              slideCopy.setAttribute(
                'data-id',
                0 + (parseInt(slideDataID) - (slides.length + slideOffset)) + 20
              );
